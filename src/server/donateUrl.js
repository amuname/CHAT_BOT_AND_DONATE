...
module.exports = function(price,success_URL){
	...
	return `https://yoomoney.ru/quickpay/confirm.xml?receiver=${receiver}&successURL=${success_URL}&label=&quickpay-form=donate&is-inner-form=true&targets=${target}&comment=%09&sum=${price}&paymentType=AC`
} 