...
module.exports = function(price,user,time){
	...
	return `https://yoomoney.ru/quickpay/confirm.xml?receiver=${receiver}&successURL=${successURL}&label=&quickpay-form=donate&is-inner-form=true&referer=${referer}&targets=${target}&comment=%09&sum=${price}&paymentType=AC`
} 